...
public class ExtendedJedisPoolConfig extends JedisPoolConfig {
    ...
    public ExtendedJedisPoolConfig withMaxConsecutiveConnectionFailures(final int maxConsecutiveConnectionFailures) {
    ...
    public ExtendedJedisPoolConfig withMinEvictableIdleTimeMillis(final long minEvictableIdleTimeMillis) {
        setMinEvictableIdleTimeMillis( minEvictableIdleTimeMillis );
        return this;
    }

    public ExtendedJedisPoolConfig withSoftMinEvictableIdleTimeMillis(final long softMinEvictableIdleTimeMillis) {
    ...
    public ExtendedJedisPoolConfig withTimeBetweenEvictionRunsMillis(final long timeBetweenEvictionRunsMillis) {
